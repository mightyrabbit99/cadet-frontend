...
import { controlButton, controlSwitch } from '../commons';
...
class ControlBar extends React.PureComponent<ControlBarProps, {}> {
  ...
  private editorControl() {
    const debuggerSwitchFunction = (checked: boolean) => {
      checked? this.props.handleActivateDebugger() : this.props.handleDeactivateDebugger();
    }; 
    const runButton = (
    ...
    const resumeButton = controlButton('Resume', IconNames.STOP, () => this.props.handleDebuggerResume(this.props.debuggerActive));
    const resetButton = controlButton('Reset', IconNames.STOP, this.props.handleDebuggerReset);
    const activeDebuggerSwitch = controlSwitch('Debugger', IconNames.PLAY, debuggerSwitchFunction, this.props.isRunning);
    ...
    return (
      <div className="ControlBar_editor pt-button-group">
        ...
        {this.props.debuggerAllowed ? activeDebuggerSwitch : null}
      </div>
    );
  }

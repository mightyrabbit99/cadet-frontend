...
export const DEBUG_NEXT = 'DEBUG_NEXT';
export const DEBUG_RESET = 'DEBUG_RESET';
export const DEBUG_RESUME = 'DEBUG_RESUME';
export const DEBUG_STEP_OVER = 'DEBUG_STEP_OVER';
export const DEBUG_STEP_OUT = 'DEBUG_STEP_OUT';
export const ACTIVATE_DEBUG = 'ACTIVATE_DEBUG';
export const DEACTIVATE_DEBUG = 'DEACTIVATE_DEBUG';
...
export const SET_EDITOR_BREAKPOINTS = 'SET_EDITOR_BREAKPOINTS';
